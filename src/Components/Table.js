               ...
               <td className={`${Text} float-right flex-rows gap-2`}>
                    {
                         admin === true ? (
                              <>
                                   <button className='border border-green-500 bg-main flex-rows gap-2 text-border rounded py-1 px-2'>
                              ...
                              : (
                                   <>
                                        ...
                                        <Link to={`/movie/${movie?.name}`} className='border  border-main flex-rows gap-2 text-white rounded py-1 px-2'>
